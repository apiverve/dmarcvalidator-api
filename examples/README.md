# DMARC Validator API - Examples

This folder contains example code for using the DMARC Validator API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/dmarcvalidator',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/dmarcvalidator");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/dmarcvalidator](https://docs.apiverve.com/ref/dmarcvalidator)
