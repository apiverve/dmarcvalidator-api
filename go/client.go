...
const (
	baseURL        = "https://api.apiverve.com/v1/dmarcvalidator"
	defaultTimeout = 30 * time.Second
)

// Client is the DMARC Validator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new DMARC Validator API client.
...
// Execute makes a request to the DMARC Validator API with typed parameters.
//
