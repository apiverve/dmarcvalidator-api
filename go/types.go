// Package dmarcvalidator provides a Go client for the DMARC Validator API.
//
// For more information, visit: https://dmarcvalidator.apiverve.com?utm_source=go&utm_medium=readme
package dmarcvalidator
...
// Request contains the parameters for the DMARC Validator API.
//
// Parameters:
//   - domain (required): string - The domain to validate the DMARC record for
type Request struct {
...
// ResponseData contains the data returned by the DMARC Validator API.
type ResponseData struct {
	DmarcHost string `json:"dmarcHost"`
	DmarcRecord string `json:"dmarc_record"`
	HasDmarc bool `json:"hasDmarc"`
	Host string `json:"host"`
	P string `json:"p"`
	Rua RuaData `json:"rua"`
	Ruf RufData `json:"ruf"`
	V string `json:"v"`
	Valid bool `json:"valid"`
}

// RuaData represents the rua object.
type RuaData struct {
...
// RufData represents the ruf object.
type RufData struct {
	Domain string `json:"domain"`
	Email string `json:"email"`
	Valid bool `json:"valid"`
