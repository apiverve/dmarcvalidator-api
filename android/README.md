...
```gradle
dependencies {
    implementation 'com.github.apiverve:dmarcvalidator-api:1.1.14'
}
```
...
```java
import com.apiverve.dmarcvalidator.DMARCValidatorAPIClient;
import com.apiverve.dmarcvalidator.APIResponse;
import com.apiverve.dmarcvalidator.APIException;

// Initialize the client
DMARCValidatorAPIClient client = new DMARCValidatorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("domain", "paypal.com");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/dmarcvalidator](https://docs.apiverve.com/ref/dmarcvalidator)
...
- **Documentation:** [https://docs.apiverve.com/ref/dmarcvalidator](https://docs.apiverve.com/ref/dmarcvalidator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/dmarcvalidator-api/issues)
