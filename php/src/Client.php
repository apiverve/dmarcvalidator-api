...
namespace APIVerve\Dmarcvalidator;
...
/**
 * Client for the DMARC Validator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://dmarcvalidator.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/dmarcvalidator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DmarcvalidatorClient] {$message}\n";
        }
    }
}
