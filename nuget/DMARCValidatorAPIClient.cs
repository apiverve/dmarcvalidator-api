...
namespace APIVerve.API.DMARCValidator
{
    ...
    /// <summary>
    /// Client for the DMARCValidator API
    /// </summary>
    public class DMARCValidatorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/dmarcvalidator";
        ...
        public DMARCValidatorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DMARCValidatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DMARCValidatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, DMARCValidatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(DMARCValidatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(DMARCValidatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(DMARCValidatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(DMARCValidatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(DMARCValidatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(DMARCValidatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(DMARCValidatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(DMARCValidatorQueryOptions options)
        {
