...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/dmarcvalidator',
        'Source': 'https://github.com/apiverve/dmarcvalidator-api',
        'Bug Tracker': 'https://github.com/apiverve/dmarcvalidator-api/issues'
    },
    classifiers=[
